<x-app-layout>
    ...
    <div class="flex-col items-center mx-auto w-3/4 m-5">
        <form action="{{ route('storenews') }}" method="POST">
            ...
            <div class="mb-4 w-full">
                <textarea name="description" cols="30" rows="10" class="border border-gray-300 p-2 w-full" placeholder="What's on your mind?"></textarea>
            </div>
            ...
            <div class="text-center">
                <button type="submit" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mb-5">Post</button>
            </div>
